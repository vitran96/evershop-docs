    ...
    <div className='flex flex-col md:flex-row md:space-y-0 justify-center '>
      <div>
        ...
        <div className='flex justify-center'>
          <img src='/img/graphql-react.webp' style={{ boxShadow: "0px 5px 30px rgb(0 0 0 / 10%), 0px 1px 4px rgb(0 0 0 / 5%)", borderRadius: '12px', width: '800px', maxWidth: '100%' }} />
        </div>
      </div>
    </div>
  </div>
